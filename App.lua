App =
{
	...
	instrument =
	{
		...
		{num_strings = 10, open = {52, 45, 38, 31, 24, 40, 45, 50, 55, 60}, recent = {52, 45, 38, 31, 24, 40, 45, 50, 55, 60}, "E3", "A2", "D2", "G1", "C1", "E2", "A2", "D3", "G3", "C4"}
	},
...
function App.Init()
	...
	reaper.ImGui_Attach(App.ctx, App.icon_font)
